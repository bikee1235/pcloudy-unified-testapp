...
public class BloodRequestAdapter extends RecyclerView.Adapter<BloodRequestAdapter.PostHolder> implements View.OnClickListener {
        ...
        public PostHolder(@NonNull View itemView) {
            ...
            connect.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    String[] contactnum = contactvalue.split(":");
                    String namevalue = Name.getText().toString()+"";
                    String[] name = namevalue.split(":");
                 //   Toast.makeText(view.getContext(), contactnum+"", Toast.LENGTH_LONG).show();
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(view.getContext());
                    builder1.setMessage("You can contact "+name[1] +" on given contact Number in the list ");
...
//                            });
    ...
    public void onBindViewHolder(PostHolder postHolder, int i) {
        ...
        postHolder.contact.setText(""+customUserData.getName());
